...
//     { id: 4, title: "ADD-ONS", active: false },
//     { id: 5, title: "SUMMARY", active: false },
//   ]);
...
//     if (stepNumber == 2) {
//       if (
//         myInfo.country.length == 0 ||
//         myInfo.college.length == 0 ||
//         myInfo.course.length ==0 ||
//         myInfo.language.length == 0
//       ) {
//         setIsEmpty(true);
//         return;
//       } else {
...
//     });
//   };
//   const changemyInfo = (event) => {
//     setMyInfo((prevInfo) => {
//       return { ...prevInfo, [event.target.name]: event.target.value };
//     });
//   };
//   // const changemyInfo = (name, value) => {
//   //   setMyInfo(prevInfo => ({
//   //     ...prevInfo,
//   //     [name]: value
//   //   }));
...
const Form = () => {
  ...
  return (
    <div className="container">
      <div className="bg-[#d6d9e6] md:bg-white rounded-xl md:p-3 md:flex justify-center">
        <div className="relative">
          <img className="hidden md:block" src={BackgroundSidebar} alt="sidebar" />
          <img className="block md:hidden w-full" src={BackgroundSidebarMobile} alt="topbar" />
